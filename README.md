...
- **Model Info** - One-click summary of the selected model's architecture, capabilities, and any models currently loaded in memory
...
- **Efficient Polling** - Connection checks pause automatically when the widget is collapsed
